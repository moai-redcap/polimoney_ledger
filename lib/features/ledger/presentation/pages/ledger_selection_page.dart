...
class LedgerSelectionPage extends StatefulWidget {
  const LedgerSelectionPage({super.key});

  @override
  State<LedgerSelectionPage> createState() => _LedgerSelectionPageState();
}

class _LedgerSelectionPageState extends State<LedgerSelectionPage> {
  int _selectedIndex = 0; // State for the NavigationRail
  ...
  Widget build(BuildContext context) {
    // The DefaultTabController is removed.
    return Scaffold(
      appBar: AppBar(
        ...
        // The 'bottom' property with the TabBar is removed.
      ),
      body: Row(
        children: [
