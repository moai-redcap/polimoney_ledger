...
| #   | タスク                         | 状態      | 詳細                                              |
| --- | ------------------------------ | --------- | ------------------------------------------------- |
| 1   | 仕訳登録：日付初期値の改善     | 🔲 未着手 | 現在年度なら当日、過去年度なら1/1をセット         |
| 2   | 仕訳登録：締め済み年度で非表示 | 🔲 未着手 | closed/locked年度では「仕訳を登録」ボタンを非表示 |
| 3   | 台帳設定・メンバー管理         | 🔲 未着手 | LedgerSettingsScreen                              |
| 4   | 複合仕訳対応                   | 🔲 未着手 | 複数行の支払元                                    |
| 5   | 関係者匿名化ロジック           | 🔲 未着手 | Hub 同期時の匿名化処理                            |
| 6   | アーカイブ時の画像移行         | 🔲 未着手 | Hub Storage への移行（Hub連携後）                 |
