        ...
        <div class="st-card__content" style="padding: var(--st-sys-spacing-6);">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="st-field">
              <label class="st-field__label-wrapper">
                <span class="st-field__label">
                  日付{" "}
                  {!isFullPublicSubsidy && <span style="color: var(--st-sys-color-error);">*</span>}
                  {isFullPublicSubsidy && (
                    <span style="color: var(--st-sys-color-on-surface-variant);">（任意）</span>
                  )}
                </span>
              </label>
              <input
            ...
            <div class="st-field">
              <label class="st-field__label-wrapper">
                <span class="st-field__label">
                  金額 <span style="color: var(--st-sys-color-error);">*</span>
                </span>
              </label>
              <input
                type="number"
          ...
          <div class="st-field">
            <label class="st-field__label-wrapper">
              <span class="st-field__label">
                摘要 <span style="color: var(--st-sys-color-error);">*</span>
              </span>
            </label>
            <input
              type="text"
          ...
          {entryType !== "transfer" && (
            <div class="st-field">
              <label class="st-field__label-wrapper">
                <span class="st-field__label">
                  関係者（支払先・寄付者など） <span style="color: var(--st-sys-color-error);">*</span>
                </span>
              </label>
              <div class="st-flex st-gap-2">
                <select
              ...
              {showAddressWarning && (
                <div class="alert alert-warning mt-2 py-2">
                  ...
                  <span style="font-size: var(--st-sys-typescale-body-small-size);">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="space-y-2">
                <div class="st-field">
                  <label class="st-field__label-wrapper">
                    <span class="st-field__label">
                      支出科目（何に使ったか） <span style="color: var(--st-sys-color-error);">*</span>
                    </span>
                  </label>
                  <select
                    class="st-select"
                ...
                {debitAccountCode &&
                  ...
                  <div class="st-field">
                    <label class="st-field__label-wrapper">
                      <span class="st-field__label">補助科目</span>
                    </label>
                    <select
              ...
              {isFullPublicSubsidy
                ? (
                  <div class="space-y-2">
                    <div class="st-field">
                      <label class="st-field__label-wrapper">
                        <span class="st-field__label">支払元</span>
                      </label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="space-y-2">
                <div class="st-field">
                  <label class="st-field__label-wrapper">
                    <span class="st-field__label">
                      振替元（どの資産から） <span style="color: var(--st-sys-color-error);">*</span>
                    </span>
                  </label>
                  <select
                    class="st-select"
              ...
              <div class="space-y-2">
                <div class="st-field">
                  <label class="st-field__label-wrapper">
                    <span class="st-field__label">
                      振替先（どの資産へ） <span style="color: var(--st-sys-color-error);">*</span>
                    </span>
                  </label>
                  <select
                    class="st-select"
      ...
      <div class="st-card st-card--filled">
        <div class="st-card__content" style="padding: var(--st-sys-spacing-6);">
          ...
          {ledgerType === "election" && (
            <div class="st-field">
              <label class="st-field__label-wrapper">
                <span class="st-field__label">活動区分</span>
              </label>
              <div class="st-flex st-gap-4">
                <label class="label cursor-pointer gap-2">
                  ...
                  />
                  <span class="st-field__label">立候補準備</span>
                </label>
                <label class="label cursor-pointer gap-2">
                  <input
                    type="radio"
                  ...
                  />
                  <span class="st-field__label">選挙運動</span>
                </label>
              </div>
            </div>
          )}
            ...
            <div class="st-stack st-stack--md">
              ...
              {isFullPublicSubsidy && (
                <div class="st-alert st-alert--info">
                  ...
                  <div>
                    <p style="font-weight: 500;">全額公費負担モード</p>
          ...
          {ledgerType === "organization" && (
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="st-field">
                <label class="st-field__label-wrapper">
                  <span class="st-field__label">政党交付金充当額</span>
                </label>
                <input
                  type="number"
                  class="st-input"
              ...
              <div class="st-field">
                <label class="st-field__label-wrapper">
                  <span class="st-field__label">政党基金充当額</span>
                </label>
                <input
                  type="number"
                  class="st-input"
          ...
          {entryType === "expense" && (
            <div class="st-field">
              <label class="label cursor-pointer justify-start gap-3 p-3 border rounded-lg hover:bg-base-200">
                ...
                />
                <div>
                  <span class="st-field__label" style="font-weight: 500;">資産取得</span>
                  <span class="label-text-alt block text-base-content/60">
          ...
          {isAssetAcquisition && (
            <div class="st-field">
              <label class="st-field__label-wrapper">
                <span class="st-field__label">
                  資産種別 <span style="color: var(--st-sys-color-error);">*</span>
                </span>
              </label>
              <select
                class="st-select"
          ...
          <div class="st-field">
            <label class="st-field__label-wrapper">
              <span class="st-field__label">金銭以外の見積の根拠</span>
            </label>
            <input
              type="text"
              class="st-input"
          ...
          <div class="st-field">
            ...
            <div class="st-stack st-stack--sm">
              <label class="label cursor-pointer justify-start gap-2 p-3 border rounded-lg hover:bg-base-200">
                ...
                />
                <div>
                  <span class="st-field__label" style="font-weight: 500;">証憑を添付する</span>
                  <span class="label-text-alt block text-base-content/60">
                    領収書、契約書、利用明細書など
                  </span>
                </div>
              ...
              <label class="label cursor-pointer justify-start gap-2 p-3 border rounded-lg hover:bg-base-200">
                ...
                />
                <div>
                  <span class="st-field__label" style="font-weight: 500;">証憑を添付できない</span>
                  <span class="label-text-alt block text-base-content/60">
                    自動販売機、交通費など
                  </span>
                </div>
          ...
          {!isReceiptHardToCollect && (
            <div class="st-field">
              <label class="st-field__label-wrapper">
                <span class="st-field__label">
                  証憑ファイル <span style="color: var(--st-sys-color-error);">*</span>
                </span>
              </label>
              <input
                type="file"
          ...
          {isReceiptHardToCollect && (
            <div class="st-field">
              <label class="st-field__label-wrapper">
                <span class="st-field__label">
                  添付できない理由 <span style="color: var(--st-sys-color-error);">*</span>
                </span>
              </label>
              <input
                type="text"
      ...
      {showFixedButtons
        ? (
          ...
          <div class="fixed bottom-0 left-0 right-0 w-[85%] max-w-4xl ml-auto bg-base-100 border-t border-base-300 p-4 flex justify-end gap-2">
            <button type="button" class="st-button st-button--text" onClick={onCancel}>
              キャンセル
            </button>
            <button
              type="button"
